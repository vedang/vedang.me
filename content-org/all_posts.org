...
#+end_description
** DONE I have questions about COVID-19           :noexport:covid19:coronavirus:
...
#+caption: Leela Manerikar: 29th Oct 1920 -- 9th Jan 2022
file:ajji.jpg
...
Hi! I'm Vedang. I live in Pune, India and work at [[https://helpshift.com][Helpshift]]. Now a days, I work in improving Developer Productivity inside Helpshift. Previously, I was an Engineering leader working on improving processes and workflows within the Helpshift backend team with the help of my team mates. I helped design and write some of the code that runs Helpshift.

I'm passionate about programming, and some of my work can be found on [[https://github.com/vedang][GitHub]]. I use Emacs as my editor-for-everything, and blog about it from time to time.
...
I love reading books, and I write book reviews once in a while. I also have strong personal [[https://vedang.me/categories/mythology/][opinions on mythology]] and culture, and I use this space to try and convert random strangers to my point of view.

If you want to get in touch, please send me a message at vedang.manerikar on Google's email service.

*** Presentations & Talks

- (2020) [[https://www.youtube.com/watch?v=zsTXte3p0Uk][Growing a Clojure Company]]
- (2015) [[https://www.youtube.com/watch?v=k10_trKtKNk][Dead simple Scalability patterns]]

*** Interviews

- (2021) [[https://soundcloud.com/defn-771544745/defn-80][The defn podcast: Vedang Manerikar]]
...
- [[https://github.com/vedang/pdf-tools][pdf-tools]] : Emacs support library for PDF files.
- [[https://github.com/vedang/ox-neuron][ox-neuron]] : An exporter for Org-Mode, which exports org-mode content to markdown, as understood by the Neuron and Emanote Static Site generators.
- [[https://github.com/vedang/clj_fdb][clj-fdb]] : An early version Clojure wrapper on top of the Java API for FoundationDB.
- [[https://github.com/vedang/bb-scripts][bb-scripts]] : Small scripts written in Babashka.
...
* Tools                                                        :tools:@tools:
  ...
  :EXPORT_HUGO_SECTION: blog
  :END:
** DONE How to use the Clojure REBL with Leiningen, Cider and Emacs :clojure:cognitect:rebl:leiningen:cider:emacs:
   CLOSED: [2020-10-28 Wed 23:18]
   :PROPERTIES:
   :CREATED:  [2020-10-28 Wed 18:48]
   :EXPORT_FILE_NAME: clj-rebl-lein-cider-emacs
   :END:
   :LOGBOOK:
   - State "DONE"       from "WORKING"    [2020-10-28 Wed 23:18]
   - State "WORKING"    from              [2020-10-28 Wed 21:28]
   :END:
...
1. Download the [[https://docs.datomic.com/cloud/other-tools/REBL.html][REBL jar]] from Cognitect.
2. Use [[https://github.com/kumarshantanu/lein-localrepo][lein-localrepo]] to install the REBL jar to your m2.
...
3. Add the following code to your =profiles.clj= file (code below).
   This is based on the [[https://docs.datomic.com/cloud/other-tools/REBL.html#installation][REBL installation guide]] and [[https://github.com/RickMoynihan/nrebl.middleware][Rick Moynihan's
   nrepl middleware]]:
   #+begin_src clojure
     {
      ;; ....
