...
2. Projects: Some small projects that I'm working on for fun.
3. Presentations: List of presentations I've given
4. Lily's Recipes: I'm thinking of moving this under projects
...
* Tools                                                              :@tools:
  ...
  :EXPORT_HUGO_SECTION: blog
  :END:
** DRAFT Creating blog-posts from (org) Beamer presentations :orgmode:beamer:presentations:
...
- Creating a post with the slide_png as the image and the
  ...
  copy.
** DRAFT Experience Report: Using Basecamp as a Remote team :communication:collaboration:teams:project_management:
   :PROPERTIES:
...
** DONE Tinylog: Mbsync: Error: Channel <x> Is Locked                :mbsync:
   ...
   :EXPORT_HUGO_ALIASES: /techlog/2017-10-11-mbsync-channel-is-locked/
   :END:
...
** DRAFT Lazy Weekend Reading: What is User Story Mapping? :project_management:
   :PROPERTIES:
...
** DONE Lazy Weekend Reading: A love letter to Clojure              :clojure:
   ...
   :EXPORT_HUGO_ALIASES: /weblog/2019-10-13-lazy-weekend-reading-love-letter-to-clojure/
   :END:
...
** DONE Lazy Weekend Viewing: GOJEK's 10x Engineer - Truth or Myth? :engineering_management:gojek:culture:
   ...
   :EXPORT_FILE_NAME: index
   :EXPORT_HUGO_ALIASES: /weblog/2019-07-20-gojek-10x-engineering/
   :END:
*** Summary
